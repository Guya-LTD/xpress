...
class BillingMethodRepository extends AbstractDoctrineRepository implements BillingMethodInterface {
    /**
     * @var string
     */
    protected $entityClass = 'Xpress\Domain\Model\Entity\BillingMethod';
}